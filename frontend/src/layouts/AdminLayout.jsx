  ...
  return (
    <div className="h-[100dvh] flex bg-slate-50 dark:bg-slate-950 transition-colors overflow-hidden relative w-full">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-5%] w-[50%] h-[50%] rounded-full bg-purple-500/20 dark:bg-purple-500/10 blur-[120px] mix-blend-multiply dark:mix-blend-screen animate-blob animation-delay-2000" />
        <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] rounded-full bg-blue-500/20 dark:bg-blue-500/10 blur-[100px] mix-blend-multiply dark:mix-blend-screen animate-blob animation-delay-4000" />
        <div 
