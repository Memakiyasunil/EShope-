  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">My Customers</h1>
      ...
      <GlassCard className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-slate-500 max-w-md">
          We are working hard to bring you the My Customers module. Check back later for updates.
        </p>
      </GlassCard>
    </div>
  );
